...
import org.example.knowmateadmin.filter.JwtAuthFilter;
...
public class SecurityConfig {
    ...
    // 注意：添加 Spring Security 依赖后，默认会启用安全配置。
    // 你可能需要进一步配置 SecurityFilterChain Bean 来定制安全规则，
    // 例如允许对 /api/auth/** 路径的匿名访问。
    @Bean
